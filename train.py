...
class Model():
    def __init__(self, training_dataframe: str, validation_dataframe: str, train_image_dir: str, validation_image_dir: str, config: str):
    ...
    def core(self):
        i_e = image_encoder()
        t_e = text_encoder()
        train_dataset = CheXpert(self.train_image_dir, self.training_dataframe, transform = transforms)

        validation_dataset = CheXpert(self.validation_image_dir, self.validation_dataframe, transform = transforms)
...
model = Model("final_train.csv", "final_valid.csv", "CheXpert-v1.0-small/train", "CheXpert-v1.0-small/valid", "config.yaml")
